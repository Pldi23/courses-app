...
export class CourseListComponent implements OnInit, OnChanges, DoCheck, AfterContentInit, AfterContentChecked,
  ...
  public static DEFAULT_LIST_SIZE: number = 3;
  ...
  public ngOnInit(): void {
	...
	this.coursesList = this.courseService.fetch(0, CourseListComponent.DEFAULT_LIST_SIZE);
  }
  ...
  public fetchMore(): void {
	...
	.fetch(size, size + CourseListComponent.DEFAULT_LIST_SIZE);
